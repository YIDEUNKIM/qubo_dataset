...
competition. Rising $\alpha$ pushes $\Delta E$ up. Meanwhile, failing samples
drift toward $x^\star$, where the penalty $\Delta P$ is smaller, so $\Delta E$ is
pulled down. The peak sits where this pull overtakes $\alpha$
($\Delta E{=}\Delta R{+}\alpha\Delta P$, $\Delta R,\Delta P$ fixed per bitstring). The peak is
