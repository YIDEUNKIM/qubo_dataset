...
Security Specialized University Program)'' in 2026, in part by the Basic Science
Research Program through the National Research Foundation of Korea (NRF) funded
by the Ministry of Education (No.~25411243), and in part by the ``Creation of the
Quantum Information Science R\&D Ecosystem (Based on Human Resources)'' through
the NRF funded by the Korean government (RS-2023-NR057243).}
