...
\RaggedRight
Instead of ``did it succeed?'', we ask how close the failing runs come to $\xstar$. We use two quantities, over \textbf{failures only}, on a \textbf{fixed set of the $100$ hardest} instances:
\begin{itemize}
